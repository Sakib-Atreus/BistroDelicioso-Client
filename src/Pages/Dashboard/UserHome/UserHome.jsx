...
const UserHome = () => {
    ...
    // const { data: user_stats = {} } = useQuery({
    //     queryKey: ["user-stats"],
    //     queryFn: async () => {
    ...
    //   });
      ...
      const { data: user_chartData =[] } = useQuery({
        queryKey: ['user_chart-data'],
        queryFn: async () => {
            const res = await axiosSecure('/user-order-stats');
            return res.data;
        }
      })
    ...
    return (
        ...
        <div className="stat bg-pink-200 rounded-xl">
        ...
        <div className="stat bg-green-200 rounded-xl">
          <div className="stat-figure text-secondary">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
        ...
        <div className="stat bg-orange-200 rounded-xl">
          <div className="stat-figure text-secondary">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <div className="flex mt-20 rounded-xl">
        <div className="w-1/2">
          <BarChart
            width={500}
            height={300}
          ...
          >
            ...
            <Bar
              ...
              label={{ position: "top" }}
            >
              {user_chartData.map((entry, index) => (
